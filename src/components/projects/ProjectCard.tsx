...
export function ProjectCard({ project }: ProjectCardProps) {
  return (
    <div className="flex flex-col rounded-lg border border-black/[0.09] dark:border-white/10 bg-white/60 dark:bg-white/5 p-6 gap-3 hover:border-black/[0.15] dark:hover:border-white/[0.15] transition-colors">
      <div className="flex items-start justify-between gap-2">
        ...
        {project.featured && (
          <span className="px-2 py-0.5 rounded-full text-[10px] text-amber-600 dark:text-amber-400 bg-amber-500/10 border border-amber-500/20 shrink-0">
            Featured
          </span>
        )}
      </div>
