    ...
    <section className="py-12 border-t border-white/[0.06]">
      ...
      >
        <div className="space-y-1">
          <p className="text-[10px] text-neutral-600 tracking-widest uppercase">Work Style</p>
          <h2 className="text-xl font-semibold text-white">일하는 방식</h2>
        </div>

        <div className="grid gap-4 sm:grid-cols-2">
          {/* Preferred */}
          <div className="rounded-2xl p-5 bg-white/[0.04] border border-white/[0.08] space-y-3">
            <p className="text-[10px] text-emerald-500/80 tracking-widest uppercase font-medium">
              선호하는 환경
            </p>
        ...
        <div className="rounded-2xl p-5 bg-white/[0.03] border border-white/[0.06]">
          <p className="text-[10px] text-neutral-600 tracking-widest uppercase mb-2">종합 요약</p>
